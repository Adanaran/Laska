...
%   Führt die Zugfolge von Farbe auf Brett mit der Länge aus und gibt
%   das resultierende virtuelle Brett zurück.
...
virtuellZug(Brett,schwarz,Zugfolge,4,PRes):-
	...
	feld(FeldA,IndexA),
	feld(FeldZ,IndexZ),
	feldZwischen(FeldA,FeldZ,FeldÜ),
	feld(FeldÜ,IndexÜ),

	nth1(IndexA,Brett,TurmZiehend,BrettRest),
	nth1(IndexA,Brett2,[],BrettRest),

	nth1(IndexÜ,Brett2,[KopfGeschlagen|RestGeschlagen],BrettRest2),
	append(TurmZiehend,[KopfGeschlagen],TurmZiehendMitKopf),
	nth1(IndexÜ,Brett3,RestGeschlagen,BrettRest2),
